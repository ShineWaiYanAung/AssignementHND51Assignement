...
class _CourseDetailState extends State<CourseDetail>
      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 10, right: 15, left: 15),
              child: buildCourseOverView(context,widget.course),
            ),
            const SizedBox(
              height: 30,
            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:  TabBarView(
                      children: [
                        ///NeedToBeImpelemted
                        LecturesDetail(eachCourse: widget.course,),
                        ZoomMeeting(),
                        HandInLecture(),
                      ],
                    ),
  ...
  Widget buildCourseOverView(BuildContext context, CourseModel eachCourse) {
    return Container(
      height: 250,
      decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 20,right: 10,bottom: 10,top: 20), // Added padding for spacing
            child: Row(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10), // Added spacing between texts
                    ],
                  ),
                ),
                CircleAvatar(
                  radius: 30,
                  backgroundImage: AssetImage("AppImages/PersonIcon/maleStudent.png"),
                ),
              ],
            ),
          ),
